...
namespace Pheonyx.Game
{
	public partial class Renderer : MultiMeshInstance3D
	{
		public override void _Process(double delta)
		{
			...
			{
				var note = Runner.ProcessNotes[i];
				...
				{
					alpha -= (ad - depth) / (ad + (float)Phoenyx.Constants.HIT_WINDOW * ar / 1000);
				}
				...
				var color = Phoenyx.Skin.Colors[note.Index % Phoenyx.Skin.Colors.Length];
